    ...
    <div className="min-h-screen bg-gray-950">
      ...
      <nav className="border-b border-gray-800/60 px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <span className="text-gray-500 text-xs">Shared Analysis Report</span>
      ...
      <div className="max-w-4xl mx-auto px-4 py-10 space-y-5">
          ...
          <div className="flex items-start gap-5">
            <div className="relative w-32 h-32 flex-shrink-0">
              <svg className="w-32 h-32 -rotate-90" viewBox="0 0 120 120">
                ...
                <circle cx="60" cy="60" r={r} fill="none" strokeWidth="9" strokeLinecap="round"
                  stroke={cfg.stroke} strokeDasharray={`${(analysis.flip_score/100)*circ} ${circ}`}/>
              </svg>
            ...
            <div className="flex-1">
              ...
              <div className="grid grid-cols-3 gap-2 mb-3">
                {[
                  { label: 'Asking Price', value: formatCurrency(listing.asking_price) },
        ...
        {/* Investment thesis */}
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6">
          <h2 className="text-white font-semibold mb-3 text-sm uppercase tracking-wide text-gray-400">Investment Thesis</h2>
        ...
        {analysis.red_flags?.length > 0 && (
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6">
            <h2 className="text-white font-semibold mb-4 text-sm uppercase tracking-wide text-gray-400">Red Flags ({analysis.red_flags.length})</h2>
            <div className="space-y-3">
              {analysis.red_flags.slice(0,3).map((flag: any, i: number) => (
                <div key={i} className={`border rounded-xl p-4 ${
                  flag.severity === 'high' ? 'border-red-500/30 bg-red-950/20' :
                  flag.severity === 'medium' ? 'border-amber-500/30 bg-amber-950/20' :
        ...
        <div className="bg-gradient-to-br from-indigo-950/50 to-violet-950/50 border border-indigo-500/20 rounded-2xl p-6 text-center">
          ...
          <p className="text-gray-400 text-sm mb-5">Get FlipScore™, red flags, ROI model, and 12-month flip plan for any listing</p>
